export default {
  icons: {
    ...
    values: {
      ...
      chat: 'mdi-chat-plus-outline',
      refresh: 'mdi-refresh',
      folder_refesh: 'mdi-folder-refresh'
    }
  },
  theme: {
    themes: {
      light: {
        primary: '#124786',         // 메인 버튼, 액티브
        ...
        iframe_bg: '#FFFFFF',
        dialog_bg: '#124786',
        router_bar_bg: '#FFFFFF',
        content_menu_title_bg: '#124786',
        content_menu_bg: '#f7f7f7',
        content_menu_list_bg: '#FFFFFF',
        // dialog_bg: '#124786',
      ...
      dark: {
        ...
        iframe_bg: '#FFFFFF',
        dialog_bg: '#124786',
        router_bar_bg: '#0f2236',
        content_menu_title_bg: '#0d2843',
        content_menu_bg: '#193754',
        content_menu_list_bg: '#0f2236',
